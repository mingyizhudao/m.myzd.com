...
<?php if ($showHeader == 1) { ?>
    <header class="bg-green">
        ...
        <div class="title">让眼睛再为心灵的窗户</div>
        <nav class="right">
...
<article id="coats_article" class="active story_article" data-scroll="true">
    <div>
        ...
        <div class="pl10 pr10">
            ...
            <div class="text-justify text-indent-2 mt20 brownText">
            ...
            <div class="grid mt20">
                ...
                <div class="brownText font-s16">三天后</div>
                <div class="titleBg"></div>
            </div>
            <div class="text-justify text-indent-2 mt5">
                小马和妈妈根据名医主刀客服安排来到北京同仁医院面诊，当天就安排了眼部检查项目，检查结果在一周以后出来，期间，名医主刀专业客服一直和小马保持联系，让小马和妈妈感受到了来自名医主刀的关心。
            </div>
            <div class="grid mt20">
                <div class="titleBg"></div>
                <div class="brownText font-s16">一周后</div>
                <div class="titleBg"></div>
            </div>
            <div class="text-justify text-indent-2 mt5">
                小马和妈妈带着检查报告找到朱晓青主任，主任确认了进行手术的必要性，并迅速安排下来，小马第二天就办理入院，等待3月1号的眼部手术。
            </div>
            <div class="grid mt20">
                <div class="titleBg"></div>
                <div class="brownText font-s16">手术进行的很顺利</div>
                <div class="titleBg"></div>
            </div>
            <div class="text-justify text-indent-2 mt5">
