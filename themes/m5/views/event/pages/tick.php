<?php
$this->setPageTitle('身首异处的蜱虫，你威风啥？');
...
<?php if ($showHeader == 1) { ?>
    <header class="bg-green">
        ...
        <div class="title">身首异处的蜱虫，你威风啥？</div>
        <nav class="right">
...
<?php } ?>
<article id="tick_article" class="active story_article" data-scroll="true">
    <div class="color-black">
        <div>
            <img src="http://static.mingyizhudao.com/146951926429760" class="w100">
        </div>
        <div class="pl10 pr10">
            <div class="colorblue2 font-w800 font-s18 pt20">
                身首异处的蜱虫，你威风啥？
            </div>
            ...
            <div class="pt10">
                <img src="http://static.mingyizhudao.com/146951955436852" class="w100">
            </div>
            <div class="pt10 font-w800">
                事件回放：
            </div>
            ...
            <div class="pt10">
                <img src="http://static.mingyizhudao.com/146952030430077" class="w100">
            </div>
            <div class="font-s12 text-center color-black7">
                唐代彬主任工作照
            </div>
            <div class="pt10 text-indent-2 text-justify">
            ...
            <div class="pt20">
                <span class="font-w800">预防：</span>蜱虫主要栖息在森林、灌木丛、草丛以及山地的泥土中，有的寄生在动物身上。蜱虫吸血时常会附着在人的头皮、腰部、腋窝、腹股沟及脚踝下方等部位。
            </div>
            ...
            <div class="pt10">
                <span class="font-w800">不慎被咬伤的处理：</span>一旦被蜱虫咬伤也不必过于恐慌，不少家住农村尤其是林区或者养狗、猫宠物的市民都有被蜱虫咬伤的经历，但真正被感染疾病的几率很低,只要及早发现并及时到医院配合合理的治疗,被蜱虫咬伤后绝大多数不会危及生命。
            </div>
            <div class="pt10 colorBlue">
