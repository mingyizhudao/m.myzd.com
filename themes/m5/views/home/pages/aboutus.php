...
在第一时间预约全国知名专家，安排入院手术。
      ...
      <div class="text-justify" style="color:#2E5456;">
       公司总部坐落于上海，现设北京、杭州、天津、广州、南京、济南、成都、延安等分部，业务范围覆盖全国。平台汇聚了国内外
优质名医资源和闲置床位资源，并利用互联网技术实现医患精准匹配，医疗资源优化配置，帮助患者解决<span>“好看病，看好病”</span>的切实需求。
      </div>
   
   <div class="text-center">
     <img src="http://static.mingyizhudao.com/147245840481765" width="21">  
   </div>
   <div class="text-center ">
      <img src="http://static.mingyizhudao.com/14724584094842" width="223"> 
   </div>
   <div class="mt10 text-justify">
     平台汇聚了全球三万名以上三甲医院副主任级别及以上的医师，并与工程院院士等级别的专家团队、美国凯瑟琳癌症中心、梅奥诊所
等世界著名医疗机构深度合作。签约医师涵盖不同的科室，能让更多患者通过这一平台精准对接到擅长相关疾病的专家，从而节省了
在不同医院门诊排队的时间，并减少患者乱投医而产生的额外费用。  
   </div>
   <div class="text-center">
     <img src="http://static.mingyizhudao.com/147245872641968" width="20">  
   </div>
   <div class="text-center ">
      <img src="http://static.mingyizhudao.com/147245873040011" width="223"> 
   </div>
   <div class="text-justify mt10">
    名医主刀与国内多家三甲医院、二甲医院、民营医院合作，基层首诊患者通过名医主刀平台可对接三甲医院医生，在有闲置床位资源的
二甲医院或者民营医院进行手术治疗，缓解三甲医院门诊压力，提高基层医院医疗资源的有效利用。通过名医主刀，患者不仅可以获得专家细致、专业的诊疗服务，还可以缩短治疗的等候时间。在名医主刀，经过对医疗资源的优化配置，
预约手术时间可以缩短为一个星期，极大程度的避免了因为手术延迟而耽误病情。   
   </div>
   <div class="text-center">
     <img src="http://static.mingyizhudao.com/147245900736936" width="19">  
   </div>
   <div class="text-center ">
      <img src="http://static.mingyizhudao.com/147245900383939" width="223"> 
   </div>
   <div class="text-justify mt10 mb50">
