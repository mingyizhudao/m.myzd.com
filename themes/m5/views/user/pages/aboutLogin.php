...
<article class="active" data-scroll="true">
    <div class="pl15 pr15 text-justify">
        ...
        <div class="pt10 color-black6">
            一个手机号只能被注册一次，该提示说明您的手机号已经注册过，不能再次注册。建议直接使用该手机号登录，可以在登录界面点击“获取验证码”，之后通过验证码登录。如仍不成功，请您拨打名医主刀客服电话400-119-7900，我们将为您解决。
        </div>
        <div class="pt25 font-s16">
            4.一直收不到验证码或提示"验证码错误"？
        </div>
        ...
        <div class="pt10 color-black6">
            （4）若以上都不成功，请您拨打名医主刀客服电话400-119-7900。我们将为您解决。
        </div>
        <div class="pt25 font-s16">
            5.登录方式有哪几种？（适用于网站）
        </div>
