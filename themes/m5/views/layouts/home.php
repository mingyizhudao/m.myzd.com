...
<html lang="zh" xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
    <head>
        ...
        Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl . '/js/jquery-1.9.1.min.js/jquery.bxslider/jquery.bxslider.min.js', CClientScript::POS_HEAD);
        ?>
    </head>
    <body>
        <?php
        if ($this->showHeader()) {
            $this->renderPartial('//layouts/headerHome');
        }
        ?>
        <!-- /header -->
