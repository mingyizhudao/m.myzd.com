...
Yii::app()->clientScript->registerScriptFile('http://static.mingyizhudao.com/m/bookingCorpPatient.min.1.0.js', CClientScript::POS_END);
Yii::app()->clientScript->registerScriptFile('http://static.mingyizhudao.com/m/bookingCorp.min.1.0.js', CClientScript::POS_END);
/*
 * $model BookQuickForm.
 */
