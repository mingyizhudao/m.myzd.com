        ...
        <div class="page row">
            ...
            <section class="page-section">
                <div class="section-body">
                    <div class="zhitongche-title pt50">流 程</div>
                    <div class="step">
                        <div class="ui-grid-a">
                            ...
                            <div class="ui-block-a">
                                <div class="introduce-title text-right step2">术前会诊</div>
                            ...
                            <div class="ui-block-a">
                                <div class="introduce-title text-right step4">术后回访</div>
                                <div class="clearfix"></div>
            ...
            <section class="page-section">
                <div class="section-body">
                    <div class="zhitongche-title pt50">优 势</div>
                    <div class="long">
                        <div class="ui-grid-a">
                            <div class="ui-block-a"></div>
                            <div class="ui-block-b">
                            ...
                            <div class="ui-block-a mt-20">
                                <div class="introduce-title text-right step2">高效便捷</div>
                                <div class="clearfix"></div>
                            ...
                            <div class="clearfix"></div>
                            <div class="ui-block-a mt-20">
                                <div class="introduce-title text-right step4">安全保障</div>
                                <div class="clearfix"></div>
