            ...
            <ul class="list">
                ...
                <li>
                    <div class="grid">
                        ...
                        <div class="col-0 w-div"><?php echo $results->hospitalName; ?></div>
                    </div>
                </li>
                ...
                <li>
                    <div class="grid">
                        ...
                        <div class="col-0 w-div"><?php echo $results->hpDeptName; ?></div>
                    </div>
                </li>
                <li>
                    <div class="grid">
                        <div class="col-0 w100p">就诊专家:</div>
                        <div class="col-0 w-div"><?php echo $results->expertName; ?></div>
                    </div>
                </li>
                <li>
                    <div class="grid">
                        <div class="col-0 w100p">意向就诊日期:</div>
                        <div class="col-0 w-div"><?php echo $results->dateStart; ?>至<?php echo $results->dateEnd; ?></div>
                    </div>
                </li>
                <li class="nopadding h15p"></li>
                <li>
