...
<script type="text/javascript">
    /*<![CDATA[*/
    jQuery(function($) {
        jQuery('body').on('click','.items .view.hospital .btn-delete',function(){if(confirm('Are you sure you want to delete this faculty?')) {jQuery.yii.submitForm(this,this.href,{});return false;} else return false;});       
    });
    /*]]>*/
</script>