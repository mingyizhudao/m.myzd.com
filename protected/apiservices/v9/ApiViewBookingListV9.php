...
class ApiViewBookingListV9 extends EApiViewService{
    private $user;
    private $bk_status;
...
//        $this->Bookings=array();
    ...
    private function loadBookings(){
        $models = Booking::model()->getAllByUserIdOrMobile($this->user->getId(), $this->user->getMobile(), null, array('order'=>'t.id DESC'), $this->bk_status);
