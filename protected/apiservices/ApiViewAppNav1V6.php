...
class ApiViewAppNav1V6 extends EApiViewService {
    ...
    protected function createOutput() {
        if (is_null($this->output)) {
            $this->results->diseaseHeadUrl = Yii::app()->createAbsoluteUrl('/api/view', array('model'=>'disease', 'id' => ''));
            $this->results->doctorUrl = Yii::app()->createAbsoluteUrl('api/doctor', array('disease' => ''));
            $this->output = array(
