...
class ApiViewHospitalDept extends EApiViewService {
    ...
    private function setDoctors(array $models) {
        ...
        //    $doctor->bookingUrl = Yii::app()->createAbsoluteUrl('/mobile/home/enquiry', array('doctor' => $model->getId()));
            $doctor->bookingUrl = Yii::app()->createAbsoluteUrl('/mobile/booking/create', array('did' => $model->getId(), 'header' => 0, 'footer' => 0));
            $this->doctors[] = $doctor;
        }
    }
