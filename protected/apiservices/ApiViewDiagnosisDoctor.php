...
class ApiViewDiagnosisDoctor extends EApiViewService {
    ...
    public function __construct($value) {
        $this->hp_dept_id = $value['hp'];
        $this->city_id = $value['city'];
        parent::__construct();
    }
    ...
    public function loadDoctors() {
        ...
        $attrs = array('hp_dept_id' => $this->hp_dept_id,'city_id' => $this->city_id);
        $models = Doctor::model()->getAllByAttributes($attrs);
