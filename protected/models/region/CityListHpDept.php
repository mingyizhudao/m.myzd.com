...
/**
 * This is the model class for table "city_list_hp_dept".
 *
 * The followings are the available columns in table 'city_list_hp_dept':
 * @property integer $id
 ...
 */
class CityListHpDept extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('state_id, city_id, date_created', 'required'),
	 ...
	 * @return CityListHpDept the static model class
	 */
	 ...
	 */
	public function getAllCityByHospital(){
	    $criteria = new CDbCriteria();
